...
import { AppWrapper, useProjectJSON, ActiveItemContext } from "@koadz/playground";
		...
		<ThemeContextProvider>
			<AppWrapper>
				<BrikWrapper
					...
					data={projectData?.project?.pages?.[0]?.data[0]?.cols[0]?.colData?.[0]}>
					<Brik data={projectData?.project?.pages?.[0]?.data[0]?.cols[0]?.colData?.[0]} />
				</BrikWrapper>
			</AppWrapper>
		</ThemeContextProvider>
	);
